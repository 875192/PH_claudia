 ...
 * Archivo: tableros.c
 * Descripción: Definición de las cuadriculas de test (CELDA[NUM_FILAS][NUM_COLUMNAS]) y la solución.
 *              Todas las matrices están alineadas para uso con las rutinas ARM del proyecto.
 */

#include "tableros.h"

CELDA __attribute__((aligned(32)))
